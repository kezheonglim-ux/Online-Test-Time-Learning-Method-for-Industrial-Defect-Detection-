...
- [2. Dataset](#2-dataset)
- [3. Complete Project Development Flow](#3-complete-project-development-flow)
  - [3.1 Stage 1 — Offline Normal-Reference Preparation](#31-stage-1--offline-normal-reference-preparation)
  - [3.2 Stage 2 — Deployment Calibration](#32-stage-2--deployment-calibration)
  - [3.3 Stage 3 — Global-to-Local Representation Development](#33-stage-3--global-to-local-representation-development)
  - [3.4 Stage 4 — Safe Continual Test-Time Adaptation](#34-stage-4--safe-continual-test-time-adaptation)
  - [3.5 Stage 5 — Flask and CiRA CORE Deployment](#35-stage-5--flask-and-cira-core-deployment)
- [4. Final Method](#4-final-method)
- [5. Experimental Development](#5-experimental-development)
- [6. Final Results](#6-final-results)
- [7. Deployment and CiRA CORE Operation](#7-deployment-and-cira-core-operation)
- [8. Main Findings](#8-main-findings)
- [9. Limitations](#9-limitations)
- [10. Technical Detail](#10-technical-detail)
...
# 3. Complete Project Development Flow

## 3.1 Stage 1 — Offline Normal-Reference Preparation
...
## 3.2 Stage 2 — Deployment Calibration
...
## 3.3 Stage 3 — Global-to-Local Representation Development
...
## 3.4 Stage 4 — Safe Continual Test-Time Adaptation
...
## 3.5 Stage 5 — Flask and CiRA CORE Deployment
...
# 7. Deployment and CiRA CORE Operation
...
## 7.3 CiRA CORE Run Flow and Low-Code Prototype
