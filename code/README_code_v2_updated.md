...
- [8. Result Files](#8-result-files)
- [9. Reproducibility](#9-reproducibility)
- [10. Current Limitations and Next Work](#10-current-limitations-and-next-work)
...
The final experiment outputs are stored under [`code/result/`](result/).
...
Final experiment outputs are organized under:
...
Each CTTA run should preserve its own CSV rather than overwrite another experiment.

Useful per-image fields include:
...
The `result/` directory is the evidence layer for the deployment experiments, while this README summarizes the final interpretation.
...
10. save every run separately under `code/result/`.
